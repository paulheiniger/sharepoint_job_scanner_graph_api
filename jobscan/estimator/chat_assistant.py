...
def _chat_prompt_messages(
    ...
    *,
    ...
    instructions = (
        ...
        "Sales / Inspection Trips and Truck Expense are normal business-default rows. Keep them included unless the estimator explicitly excludes them. "
        "If both the current job address and verified current-job mileage are missing, leave round_trip_miles unset, mark the calculation as needing input, "
        "and ask for the site address. Never copy route mileage from a comparable or historical estimate into the current job. "
