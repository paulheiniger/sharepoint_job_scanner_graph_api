    ...
    user_content: list[dict[str, Any]] = [
        {
            ...
            "text": (
                ...
                "Draw an approximate straight-line exterior perimeter around the target connected roof complex for commercial roofing measurement. "
                ...
                "For roof wings, additions, or masses connected by roof, wall, or a narrow roof-level connector, return ONE polygon tracing their combined outside perimeter. "
                "Do NOT return a separate rectangle around each wing or roof plane. Internal parapets, elevation changes, and seams are not exterior boundaries. "
                "Return separate polygons only for genuinely detached buildings separated by open ground, parking, or roads. "
                "Use enough corners to represent the combined building outline, usually 8 to 30 points for a complex school or commercial building. "
