...
CREATE INDEX IF NOT EXISTS idx_daily_dispatch_crew_assignments_date ON daily_dispatch_crew_assignments(dispatch_date);
CREATE INDEX IF NOT EXISTS idx_daily_dispatch_crew_assignments_job ON daily_dispatch_crew_assignments(job_id);
CREATE INDEX IF NOT EXISTS idx_daily_production_entries_job_date ON daily_production_entries(job_id, work_date);
