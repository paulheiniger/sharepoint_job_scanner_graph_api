...
ALTER TABLE sharepoint_incremental_runs
    ADD COLUMN IF NOT EXISTS estimates_reparsed INTEGER DEFAULT 0,
    ADD COLUMN IF NOT EXISTS tracking_reparsed INTEGER DEFAULT 0,
    ADD COLUMN IF NOT EXISTS timesheets_reparsed INTEGER DEFAULT 0,
    ADD COLUMN IF NOT EXISTS job_files_downloaded INTEGER DEFAULT 0,
    ADD COLUMN IF NOT EXISTS job_files_deleted INTEGER DEFAULT 0;
